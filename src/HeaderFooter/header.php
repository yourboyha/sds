...
<nav id="top-navbar" class="navbar navbar-expand-lg" style="background-color: #800000">
  <div class="d-flex align-items-center">
    ...
    <a href="/sds/index.php?page=home" class="navbar-brand text-white  ms-3">
      <!-- System Name -->
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
          <?php if ($_SESSION['role'] === 'admin'): ?>
            ...
            <li><a href="index.php?page=admin-report" class="dropdown-item">ดูรายงาน</a></li>
          <?php elseif ($_SESSION['role'] === 'departmentHead'): ?>
            <li><a href="index.php?page=depart" class="dropdown-item">แผงควบคุม</a></li>
            <li><a href="index.php?page=depart-course" class="dropdown-item">จัดการหลักสูตร</a></li>
            <li><a href="index.php?page=depart-subject" class="dropdown-item">จัดการรายวิชา</a></li>
            <li><a href="index.php?page=depart-schedule" class="dropdown-item">จัดการตารางเรียน</a>
            </li>
            <li><a href="index.php?page=depart-report" class="dropdown-item">ดูรายงาน</a></li>
          <?php elseif ($_SESSION['role'] === 'academicStaff'): ?>
            <li><a href="index.php?page=acadamic" class="dropdown-item">แผงควบคุม</a></li>
            <li><a href="index.php?page=acadamic-course" class="dropdown-item">จัดการหลักสูตร</a>
            </li>
            <li><a href="index.php?page=acadamic-subject" class="dropdown-item">จัดการรายวิชา</a>
            </li>
            <li><a href="index.php?page=acadamic-schedule" class="dropdown-item">จัดการตารางเรียน</a>
            </li>
            <li><a href="index.php?page=acadamic-report" class="dropdown-item">ดูรายงาน</a></li>
          <?php elseif ($_SESSION['role'] === 'executive'): ?>
            <li><a href="index.php?page=exe-report" class="dropdown-item">ดูรายงาน</a></li>
          <?php endif; ?>
          <li><a href="src/Controller/logout.php" class="dropdown-item">ออกจากระบบ</a></li>
        </ul>
      </div>
    <?php else: ?>
